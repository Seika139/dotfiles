...
正本: `~/dotfiles/claude/ux-review/templates/`
総合ガイド: `~/dotfiles/claude/ux-review/Introduction.md`
...
- スラッシュコマンド: `~/.claude/commands/ux-review.md`
- 他サービス向け雛形: `~/dotfiles/claude/ux-review/templates/`
...
# Claude Code を終了 → 再起動（MCP を読み込むため）
```

### 2. レビュー実行

新しい Claude Code セッションで以下を打つ:
...
`~/dotfiles/claude/ux-review/templates/` から骨格がコピーされる。
