...
LOCAL_ENV_KEYS='["CREDENTIAL_PROCESS_PATH", "AWS_PROFILE", "AWS_REGION", "SLACK_WEBHOOK_URL"]'

# hooks はまるごと local 扱い（Webhook URL 等を含むため）
# → hooks キーは settings.local.json へ移動
