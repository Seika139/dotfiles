...
```text
/ux-review spark_blueprint/evaluation/ux_review newcomer
/ux-review spark_blueprint/evaluation/ux_review ip_veteran free_exploration
```
...
4. コピー後、ユーザーに以下を **編集必須** として案内:
   ...
   - `<target-path>/README.md` — プロジェクト固有の補足（任意。Spark の
     `spark_blueprint/evaluation/ux_review/README.md` を参考に）
