---
name: "scaffold"
description: "サービスの方向性から技術設計と Issue セットを生成する。Claude command /scaffold 相当を Codex CLI で実行する。"
metadata:
  short-description: "サービスの方向性から技術設計と Issue セットを生成する"
---

<!-- codex-profile-generated-from-prompt: prompts/scaffold.md -->
