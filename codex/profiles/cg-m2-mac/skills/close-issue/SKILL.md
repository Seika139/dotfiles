---
name: "close-issue"
description: "Issue のクローズ・動作確認・ブランチ片付けを行う。Claude command /close-issue 相当を Codex CLI で実行する。"
metadata:
  short-description: "Issue のクローズ・動作確認・ブランチ片付けを行う"
---

<!-- codex-profile-generated-from-prompt: prompts/close-issue.md -->
