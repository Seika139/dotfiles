---
name: "solve-issue"
description: "Issue を作成（または既存 Issue を指定）し、実装して PR を作成する。Claude command /solve-issue 相当を Codex CLI で実行する。"
metadata:
  short-description: "Issue を作成（または既存 Issue を指定）し、実装して PR を作成する"
---

<!-- codex-profile-generated-from-prompt: prompts/solve-issue.md -->
...
3. 通常の Codex の実装能力をフル活用してコードを実装する
