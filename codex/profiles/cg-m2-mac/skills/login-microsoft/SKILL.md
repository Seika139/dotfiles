...
description: "login-microsoft。Claude command /login-microsoft 相当を Codex CLI で実行する。"
metadata:
  short-description: "login-microsoft"
---

<!-- codex-profile-generated-from-prompt: prompts/login-microsoft.md -->
