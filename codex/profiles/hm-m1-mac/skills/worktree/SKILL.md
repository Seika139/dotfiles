---
name: "worktree"
description: "git worktree で隔離された作業環境を作成する。Claude command /worktree 相当を Codex CLI で実行する。"
metadata:
  short-description: "git worktree で隔離された作業環境を作成する"
---

<!-- codex-profile-generated-from-prompt: prompts/worktree.md -->
