...
description: "CHANGELOG.md を更新し、SemVer のタグを作成してgit pushします。Claude command /release/execute 相当を Codex CLI で実行する。"
metadata:
  short-description: "CHANGELOG.md を更新し、SemVer のタグを作成してgit pushします"
---

<!-- codex-profile-generated-from-prompt: prompts/release/execute.md -->
