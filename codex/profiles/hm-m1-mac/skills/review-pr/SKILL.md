---
name: "review-pr"
description: "Review a Pull Request (PR Number Required)。Claude command /review-pr 相当を Codex CLI で実行する。"
metadata:
  short-description: "Review a Pull Request (PR Number Required)"
---

<!-- codex-profile-generated-from-prompt: prompts/review-pr.md -->
