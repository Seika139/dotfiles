---
name: "aws-auth"
description: "AWS 認証情報と環境変数の注意事項。Claude command /aws-auth 相当を Codex CLI で実行する。"
metadata:
  short-description: "AWS 認証情報と環境変数の注意事項"
---

<!-- codex-profile-generated-from-prompt: prompts/aws-auth.md -->
