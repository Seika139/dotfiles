...
def sync_repo(repo: RepoConfig, webhook: DiscordWebhook | None, *, dry_run: bool = False) -> SyncResult:
...
def _sync_pull(
    ...
    *,
    ...
    reason = "Local has unpushed commits" if status == RepoStatus.AHEAD else "Branches have diverged"
